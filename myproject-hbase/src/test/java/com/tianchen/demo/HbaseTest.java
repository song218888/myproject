...
public class HbaseTest {
    ...
    static { 
        ...
        configuration.set("hbase.zookeeper.quorum", "192.168.18.83"); 
        configuration.set("hbase.master", "192.168.18.82:600000"); 
    } 
 
    public static void main(String[] args) { 
         createTable("wujintao11"); 
        // insertData("wujintao"); 
        // QueryAll("wujintao"); 
