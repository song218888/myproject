...
//	}
//
//	public com.tianchen.model.User getUser(String user) throws IOException {
//		HTableInterface users = pool.getTable(TABLE_NAME);
//
//		Get g = mkGet(user);
...
//	}
//
//	public List<com.tianchen.model.User> getUsers() throws IOException {
//		HTableInterface users = pool.getTable(TABLE_NAME);
//
//		ResultScanner results = users.getScanner(mkScan());
//		ArrayList<com.tianchen.model.User> ret = new ArrayList<com.tianchen.model.User>();
...
//	}
//
//	private static class User extends com.tianchen.model.User {
