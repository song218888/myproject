...
public abstract class Handler extends Thread {
    ...
    private void doRead(){
        ...
        System.out.println("readed from client:"+readData+", "+readData.length());
    }
...
//        }
    ...
    public boolean process(){
    	System.out.println("process readData="+readData.toString());
        if(isQuit()){
            disconnect();
            return false;
        }
    ...
    private void write(){
        ...
        System.out.println("writed to client:"+writeData+", "+writeData.length());
        interestOps(State.READING);
    }
